...
from mask_diffusion.guided_diffusion.script_util import model_and_diffusion_defaults, add_dict_to_argparser
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        miou = evaluation(opts, models)
        miou_all.append(miou)
    print('MIoU Mean: ', np.nanmean(miou_all))
    print('MIoU Std: ', np.nanstd(miou_all))
